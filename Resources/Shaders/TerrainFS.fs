...
vec4    c_rock, 
        c_dirt,
        c_grass, 
        c_blend;// order counts 
void main()
{
      // take texture data
    c_rock = texture2D(u_tex_rock,v_uv_small);
    c_dirt = texture2D(u_tex_dirt,v_uv_small);
    c_grass = texture2D(u_tex_grass,v_uv_small);
    c_blend = texture2D(u_tex_blend,v_uv_large);
    // object color
    vec4 color = c_blend.r*c_rock+c_blend.g*c_grass+c_blend.b*c_dirt;
    ...
    vec4 finalColor= vec4(u_fog_color,1.0)*alpha +color*(1.0-alpha);
    // color after fog
    ////////////////////////////////////////////////////////////////////////////////////
